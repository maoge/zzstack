...
public class PopRunner extends TaskRunner {
    
    private static Logger logger = LoggerFactory.getLogger(PopRunner.class);

    public PopRunner(AtomicLong normalCnt, AtomicLong errorCnt) {

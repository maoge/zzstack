...
public class CacheRedisHaConf implements IPaasConfig {
    
    public RedisHaConfig redisConfig;
    
    public static class RedisHaConfig {
        ...
        public RedisNodes serverA;
        public RedisNodes serverB;
